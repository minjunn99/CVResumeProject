            ...
            <div class="project-grid d-grid">
                <div class="project-item row">
                    <div class="project-img col-md-6">
                        <img src="/cvresume/assets/img/project-01.webp" alt="project image">
                    </div>
                    <div class="project-content flow col-md-6">
                        <h2 class="mb-0">
                            <span class="project-id d-block">01</span>
                            <span class="project-title d-block fs-2">Eldorado</span>
                        </h2>
                        <h3 class="project-date heading fst-italic text-secondary mb-0">2018 / 07 / 07</h3>
                        <p class="mb-0">
                            With an allusion to the old-lost city of gold, Eldorado was an incredibly challenging project, but also a highly rewarding one too. It was one of the very first projects I took on as a solo architect and working together with a team of other consultants, we achieved the result that’s a mid-century classic.
                        </p>
                        <p class="mb-0">
                ...
                <div class="project-item row">
                    <div class="project-img col-md-6">
                        <img src="/cvresume/assets/img/project-02.webp" alt="project image">
                    </div>
                    <div class="project-content flow col-md-6">
                        <h2 class="mb-0">
                            <span class="project-id d-block">02</span>
                            <span class="project-title d-block fs-2">Hi-Lo Fi</span>
                        </h2>
                        <h3 class="project-date heading fst-italic text-secondary mb-0">2016 / 02 / 12</h3>
                        <p class="mb-0">
                ...
                <div class="project-item row">
                    <div class="project-img col-md-6">
                        <img src="/cvresume/assets/img/project-03.avif" alt="project image">
                    </div>
                    <div class="project-content flow col-md-6">
                        <h2 class="mb-0">
                            <span class="project-id d-block">03</span>
                            <span class="project-title d-block fs-2">Adoro</span>
                        </h2>
                        <h3 class="project-date heading fst-italic text-secondary mb-0">2018 / 03 / 03</h3>
                        <p class="mb-0">
